...
It is assumed that you already have your project set up for VR and you have enabled VR support in the Unity Player Settings. The Virtual Console will work on any platform with Unity XR and hand controllers - that includes HTC Vive, Oculus Rift, PlayStation VR and WindowsMR.
